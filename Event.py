...
class Event:
    def __init__(self, name, description, organizer, participants, start_time, is_recurring=False,recurrence_type=None):
        self.name = name
...
class TestEvent(unittest.TestCase):
    ...
    def test_remove_participant(self):
        event = Event(self.event_name, self.event_description, self.organizer, [self.participant1, self.participant2],self.start_time)
